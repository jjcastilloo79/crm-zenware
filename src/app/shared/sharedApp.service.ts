import { mensajesToast } from '@/pages/model/constantes';
import { I_ConfirmDialog, I_MessageToast } from '@/pages/model/interfaces';
  ...
  async confirmDialog(objeto: I_ConfirmDialog): Promise<boolean> {
    return new Promise<boolean>((resolve)=>{
      this.serviceConfirmation.confirm({
        ...
        rejectButtonStyleClass: objeto.rejectButtonStyleClass??'p-button p-button-outlined surface-border text-900',  //'modalBtnRed',
